...
# Dictionary to used to map string into valid string
to_be_replaced = {
	'sin' : "np.sin",
	'cos' : 'np.cos',
	'log' : 'np.log',
...
if st.checkbox("Show User Guide", False, key='123'):	
...
st.sidebar.title("GRAPHY PLOTTER : MENU")
...
if show_graph_button:
	try:
		...
		st.markdown("### 🔔  Please enter a valid equation in Equation Box {} !!!!".format(ind+1))
